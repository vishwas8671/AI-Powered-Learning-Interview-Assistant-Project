      ...
      <div className="flex flex-col justify-center w-full px-6 py-12 lg:w-[480px] xl:w-[540px] bg-slate-950/70 backdrop-blur-md z-10">
        <div className="mx-auto w-full max-w-sm">
          ...
          <div className="mb-6">
            ...
            <p className="mt-2 text-sm text-slate-400">Initialize your student profile and begin mock runs.</p>
          </div>
      ...
      <div className="hidden lg:flex flex-1 relative items-center justify-center bg-slate-950 overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg text-center px-8">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-primary-950/40 border border-primary-800/30 text-primary-400 rounded-full mb-6">
            ...
            <span className="text-[10px] font-bold tracking-wider uppercase">Free Account Sign-Up</span>
          </div>
          <h2 className="text-4xl font-extrabold leading-tight mb-4">
            Build interview readiness with AI.
          </h2>
          <p className="text-slate-400 text-base mb-8 leading-relaxed">
            Gain immediate access to premium prep content, structured curriculum modules, and recursive code feedback loops.
          </p>

          <div className="grid grid-cols-2 gap-4 text-left">
            <div className="p-4 bg-slate-900/60 border border-slate-800/50 rounded-2xl">
              <span className="text-2xl">📈</span>
              <h3 className="font-bold text-sm text-slate-200 mt-2">Active Tracker</h3>
              <p className="text-xs text-slate-500 mt-1">Monitor study streaks, problem solving meters, and roadmap nodes.</p>
            </div>
            <div className="p-4 bg-slate-900/60 border border-slate-800/50 rounded-2xl">
              <span className="text-2xl">🎙️</span>
              <h3 className="font-bold text-sm text-slate-200 mt-2">Mock Audits</h3>
              <p className="text-xs text-slate-500 mt-1">Practice with speech recognition and get communication grades.</p>
            </div>
          </div>
        </div>
      </div>
